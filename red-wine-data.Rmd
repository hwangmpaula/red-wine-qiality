...
```{r message = FALSE, warning = FALSE, echo = FALSE, fig.width=20, fig.height=20}
...
Let's rexamine the citric acid and alcohol. We could get an idea that it has a slight correlation of 0.1. (not too strong or low)
